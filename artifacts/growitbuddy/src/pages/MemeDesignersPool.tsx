...
const config: PoolConfig = {
  ...
  defaults: {
    ...
    resources: [
      { id: "1", title: "Meme Format References",  desc: "Popular formats and templates across platforms.",              link: "https://drive.google.com/drive/folders/1MemeRef_T6uV8wX0yZ2aB4cD6eF8gH0iJ2kL4m",  btnLabel: "Open" },
      { id: "2", title: "Brand Tone Guide",         desc: "How to apply humor while staying on-brand.",                  link: "https://drive.google.com/drive/folders/1BrandTone_N6oP8qR0sT2uV4wX6yZ8aB0cD2eF4", btnLabel: "Open" },
      { id: "3", title: "Viral Meme Examples",      desc: "High-performing meme breakdowns from creator brands.",        link: "https://drive.google.com/drive/folders/1ViralMeme_G6hI8jK0lM2nO4pQ6rS8tU0vW2xY4", btnLabel: "Open" },
      { id: "4", title: "Template Pack",            desc: "Editable PSD and Canva templates for quick turnaround.",      link: "https://drive.google.com/drive/folders/1MemePack_Z6aB8cD0eF2gH4iJ6kL8mN0oP2qR4s", btnLabel: "Download" },
    ],
