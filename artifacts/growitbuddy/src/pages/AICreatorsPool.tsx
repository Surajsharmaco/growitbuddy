...
const config: PoolConfig = {
  ...
  defaults: {
    ...
    resources: [
      { id: "1", title: "AI Workflow Examples",    desc: "Real automation workflows built for creator businesses.",    link: "https://drive.google.com/drive/folders/1AIWorkflow_S6tU8vW0xY2zA4bC6dE8fG0hI2j", btnLabel: "Open" },
      { id: "2", title: "Prompt Systems",          desc: "Prompt frameworks for content, analysis, and operations.",   link: "https://drive.google.com/drive/folders/1PromptSys_K4lM6nO8pQ0rS2tU4vW6xY8zA0bC2", btnLabel: "Open" },
      { id: "3", title: "Automation Blueprints",   desc: "Flowcharts and logic maps for common automation builds.",    link: "https://drive.google.com/drive/folders/1AutoBlue_D4eF6gH8iJ0kL2mN4oP6qR8sT0uV2", btnLabel: "Download" },
      { id: "4", title: "API References",          desc: "Common integrations and API patterns we use in projects.",   link: "https://drive.google.com/drive/folders/1APIRef_W4xY6zA8bC0dE2fG4hI6jK8lM0nO2pQ4",  btnLabel: "Open" },
    ],
