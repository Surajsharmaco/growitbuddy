  ...
  return (
      ...
      >
        ...
        <div style={{ position: "relative", width: "100%", aspectRatio: "1/1", overflow: "hidden", background: page.accentColor, flexShrink: 0 }}>
          ...
          {page.followers?.trim() && (
            <div className="dn-stat-followers" style={{ position: "absolute", bottom: 14, left: 14, display: "inline-flex", flexDirection: "column", alignItems: "flex-start", gap: 1, background: "#FFFFFF", borderRadius: 14, padding: "9px 15px", border: "1px solid rgba(11,11,11,0.08)", boxShadow: "0 14px 32px -10px rgba(11,11,11,0.45), 0 2px 6px rgba(11,11,11,0.10)" }}>
              <span style={{ fontWeight: 800, fontSize: 20, color: "#0A0A0A", letterSpacing: "-0.04em", lineHeight: 1 }}>{page.followers}</span>
          ...
          <div className="dn-stat-country" style={{ position: "absolute", bottom: 14, right: 14, maxWidth: "45%", background: "rgba(255,255,255,0.85)", backdropFilter: "blur(8px)", borderRadius: 10, padding: "5px 12px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
