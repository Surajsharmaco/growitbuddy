    ...
    <div style={{ background: "#F8F8F6", fontFamily: "'Inter', sans-serif" }}>
      ...
      <section className="svc-what-section" style={{ padding: "96px 24px 100px", background: "#F8F8F6", borderTop: "1px solid #E5E5E0" }}>
        <style>{`
          ...
          .svc-bento-card.dark { background-color: #1B2636; background-image: url("data:image/svg+xml,%3Csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20width=%27160%27%20height=%27160%27%3E%3Cfilter%20id=%27g%27%3E%3CfeTurbulence%20type=%27fractalNoise%27%20baseFrequency=%270.85%27%20numOctaves=%272%27%20stitchTiles=%27stitch%27/%3E%3CfeColorMatrix%20type=%27matrix%27%20values=%270%200%200%200%201%200%200%200%200%201%200%200%200%200%201%200.35%200%200%200%200%27/%3E%3CfeComponentTransfer%3E%3CfeFuncA%20type=%27gamma%27%20amplitude=%271%27%20exponent=%271.8%27%20offset=%270%27/%3E%3C/feComponentTransfer%3E%3C/filter%3E%3Crect%20width=%27160%27%20height=%27160%27%20filter=%27url(%23g)%27/%3E%3C/svg%3E"), radial-gradient(85% 65% at 28% 10%, rgba(214,190,142,0.16) 0%, rgba(214,190,142,0) 55%), radial-gradient(125% 75% at 72% 52%, rgba(78,104,140,0.50) 0%, rgba(78,104,140,0) 62%), radial-gradient(150% 85% at 18% 100%, rgba(38,56,80,0.75) 0%, rgba(38,56,80,0) 66%), radial-gradient(110% 55% at 55% -12%, rgba(150,172,205,0.16) 0%, rgba(150,172,205,0) 52%), linear-gradient(180deg, #26364C 0%, #1E2B3D 52%, #161F2C 100%); background-size: 160px 160px, auto, auto, auto, auto, auto; background-repeat: repeat, no-repeat, no-repeat, no-repeat, no-repeat, no-repeat; background-blend-mode: soft-light, normal, normal, normal, normal, normal; border-color: rgba(255,255,255,0.10); box-shadow: 0 16px 44px -16px rgba(20,30,46,0.5); }
      ...
      {/* ── CTA ── */}
      <section className="svc-cta-section" style={{ padding: "96px 24px", backgroundColor: "#1E293B", backgroundImage: 'url("data:image/svg+xml,%3Csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20width=%27160%27%20height=%27160%27%3E%3Cfilter%20id=%27g%27%3E%3CfeTurbulence%20type=%27fractalNoise%27%20baseFrequency=%270.85%27%20numOctaves=%272%27%20stitchTiles=%27stitch%27/%3E%3CfeColorMatrix%20type=%27matrix%27%20values=%270%200%200%200%201%200%200%200%200%201%200%200%200%200%201%200.35%200%200%200%200%27/%3E%3CfeComponentTransfer%3E%3CfeFuncA%20type=%27gamma%27%20amplitude=%271%27%20exponent=%271.8%27%20offset=%270%27/%3E%3C/feComponentTransfer%3E%3C/filter%3E%3Crect%20width=%27160%27%20height=%27160%27%20filter=%27url(%23g)%27/%3E%3C/svg%3E"), radial-gradient(60% 80% at 50% 8%, rgba(214,190,142,0.14) 0%, rgba(214,190,142,0) 55%), radial-gradient(90% 70% at 25% 60%, rgba(78,104,140,0.45) 0%, rgba(78,104,140,0) 62%), radial-gradient(90% 70% at 80% 75%, rgba(46,66,92,0.55) 0%, rgba(46,66,92,0) 64%), radial-gradient(120% 60% at 50% 115%, rgba(34,50,72,0.80) 0%, rgba(34,50,72,0) 60%), linear-gradient(180deg, #243650 0%, #1B2738 55%, #161F2C 100%)', backgroundSize: "160px 160px, auto, auto, auto, auto, auto", backgroundRepeat: "repeat, no-repeat, no-repeat, no-repeat, no-repeat, no-repeat", backgroundBlendMode: "soft-light, normal, normal, normal, normal, normal" }}>
