    ...
    <div style={{ background: "#F8F8F6", fontFamily: "'Inter', sans-serif" }}>
      ...
      <section className="svc-what-section" style={{ padding: "96px 24px 100px", background: "#F8F8F6", borderTop: "1px solid #E5E5E0" }}>
        <style>{`
          ...
          .svc-bento-card.dark { background-color: #1B2636; background-image: url("data:image/svg+xml,%3Csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20width=%27150%27%20height=%27150%27%3E%3Cfilter%20id=%27gw%27%3E%3CfeTurbulence%20type=%27fractalNoise%27%20baseFrequency=%270.8%27%20numOctaves=%272%27%20seed=%272%27%20stitchTiles=%27stitch%27/%3E%3CfeColorMatrix%20type=%27matrix%27%20values=%270%200%200%200%201%200%200%200%200%201%200%200%200%200%201%200.45%200%200%200%200%27/%3E%3CfeComponentTransfer%3E%3CfeFuncA%20type=%27gamma%27%20amplitude=%271%27%20exponent=%271.3%27%20offset=%270%27/%3E%3C/feComponentTransfer%3E%3C/filter%3E%3Crect%20width=%27150%27%20height=%27150%27%20filter=%27url(%23gw)%27/%3E%3C/svg%3E"), url("data:image/svg+xml,%3Csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20width=%27150%27%20height=%27150%27%3E%3Cfilter%20id=%27gb%27%3E%3CfeTurbulence%20type=%27fractalNoise%27%20baseFrequency=%270.8%27%20numOctaves=%272%27%20seed=%278%27%20stitchTiles=%27stitch%27/%3E%3CfeColorMatrix%20type=%27matrix%27%20values=%270%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200.3%200%200%200%200%27/%3E%3CfeComponentTransfer%3E%3CfeFuncA%20type=%27gamma%27%20amplitude=%271%27%20exponent=%271.3%27%20offset=%270%27/%3E%3C/feComponentTransfer%3E%3C/filter%3E%3Crect%20width=%27150%27%20height=%27150%27%20filter=%27url(%23gb)%27/%3E%3C/svg%3E"), linear-gradient(180deg, #1F2C3F 0%, #18222F 100%); background-size: 150px 150px, 150px 150px, auto; background-repeat: repeat, repeat, no-repeat; background-blend-mode: normal, normal, normal; border-color: rgba(255,255,255,0.10); box-shadow: 0 16px 44px -16px rgba(20,30,46,0.5); }
