    ...
    <div style={{ background: "#F8F8F6", fontFamily: "'Inter', sans-serif" }}>
      ...
      <section className="svc-what-section" style={{ padding: "96px 24px 100px", background: "#F8F8F6", borderTop: "1px solid #E5E5E0" }}>
        <style>{`
          ...
          .svc-bento-card.dark { background-color: #1B2636; background-image: url("data:image/svg+xml,%3Csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20width=%27130%27%20height=%27130%27%3E%3Cfilter%20id=%27n%27%3E%3CfeTurbulence%20type=%27fractalNoise%27%20baseFrequency=%270.75%27%20numOctaves=%272%27%20stitchTiles=%27stitch%27/%3E%3CfeColorMatrix%20type=%27saturate%27%20values=%270%27/%3E%3CfeComponentTransfer%3E%3CfeFuncR%20type=%27linear%27%20slope=%271.6%27%20intercept=%27-0.3%27/%3E%3CfeFuncG%20type=%27linear%27%20slope=%271.6%27%20intercept=%27-0.3%27/%3E%3CfeFuncB%20type=%27linear%27%20slope=%271.6%27%20intercept=%27-0.3%27/%3E%3C/feComponentTransfer%3E%3C/filter%3E%3Crect%20width=%27130%27%20height=%27130%27%20filter=%27url(%23n)%27/%3E%3C/svg%3E"), radial-gradient(120% 90% at 18% 0%, rgba(194,168,120,0.12) 0%, rgba(194,168,120,0) 48%), linear-gradient(165deg, #243246 0%, #1B2636 100%); background-size: 130px 130px, auto, auto; background-repeat: repeat, no-repeat, no-repeat; background-blend-mode: overlay, normal, normal; border-color: rgba(255,255,255,0.10); box-shadow: 0 16px 44px -16px rgba(20,30,46,0.5); }
