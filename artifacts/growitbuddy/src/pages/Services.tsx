    ...
    <div style={{ background: "#F8F8F6", fontFamily: "'Inter', sans-serif" }}>
      ...
      <section className="svc-what-section" style={{ padding: "96px 24px 100px", background: "#F8F8F6", borderTop: "1px solid #E5E5E0" }}>
        <style>{`
          ...
          .svc-bento-card.dark { background-color: #1B2636; background-image: url("data:image/svg+xml,%3Csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20width=%27140%27%20height=%27140%27%3E%3Cfilter%20id=%27g%27%3E%3CfeTurbulence%20type=%27fractalNoise%27%20baseFrequency=%270.9%27%20numOctaves=%272%27%20stitchTiles=%27stitch%27/%3E%3CfeColorMatrix%20type=%27matrix%27%20values=%270%200%200%200%201%200%200%200%200%201%200%200%200%200%201%200.5%200%200%200%200%27/%3E%3CfeComponentTransfer%3E%3CfeFuncA%20type=%27gamma%27%20amplitude=%271%27%20exponent=%271.6%27%20offset=%270%27/%3E%3C/feComponentTransfer%3E%3C/filter%3E%3Crect%20width=%27140%27%20height=%27140%27%20filter=%27url(%23g)%27/%3E%3C/svg%3E"), radial-gradient(130% 100% at 12% -10%, rgba(255,255,255,0.07) 0%, rgba(255,255,255,0) 42%), radial-gradient(120% 120% at 100% 110%, rgba(194,168,120,0.10) 0%, rgba(194,168,120,0) 55%), linear-gradient(155deg, #2A3B52 0%, #1F2D40 48%, #18222F 100%); background-size: 140px 140px, auto, auto, auto; background-repeat: repeat, no-repeat, no-repeat, no-repeat; background-blend-mode: normal, normal, normal, normal; border-color: rgba(255,255,255,0.10); box-shadow: 0 16px 44px -16px rgba(20,30,46,0.5); }
      ...
      {/* ── CTA ── */}
      <section className="svc-cta-section" style={{ padding: "96px 24px", backgroundColor: "#1E293B", backgroundImage: 'url("data:image/svg+xml,%3Csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20width=%27140%27%20height=%27140%27%3E%3Cfilter%20id=%27g%27%3E%3CfeTurbulence%20type=%27fractalNoise%27%20baseFrequency=%270.9%27%20numOctaves=%272%27%20stitchTiles=%27stitch%27/%3E%3CfeColorMatrix%20type=%27matrix%27%20values=%270%200%200%200%201%200%200%200%200%201%200%200%200%200%201%200.5%200%200%200%200%27/%3E%3CfeComponentTransfer%3E%3CfeFuncA%20type=%27gamma%27%20amplitude=%271%27%20exponent=%271.6%27%20offset=%270%27/%3E%3C/feComponentTransfer%3E%3C/filter%3E%3Crect%20width=%27140%27%20height=%27140%27%20filter=%27url(%23g)%27/%3E%3C/svg%3E"), radial-gradient(90% 130% at 50% -20%, rgba(255,255,255,0.06) 0%, rgba(255,255,255,0) 45%), radial-gradient(80% 120% at 50% 120%, rgba(194,168,120,0.10) 0%, rgba(194,168,120,0) 55%), linear-gradient(160deg, #243650 0%, #1B2738 55%, #161F2C 100%)', backgroundSize: "140px 140px, auto, auto, auto", backgroundRepeat: "repeat, no-repeat, no-repeat, no-repeat", backgroundBlendMode: "normal, normal, normal, normal" }}>
