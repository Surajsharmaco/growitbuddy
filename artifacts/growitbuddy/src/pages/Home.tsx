...
export default function Home() {
  ...
  // Visible, hue-matched borders per card (one per wash above) — defined, premium.
  const AUDIENCE_BORDERS: string[] = [
    "rgba(120,150,190,0.55)", // Founders
    "rgba(196,138,112,0.55)", // Creators
    "rgba(130,176,168,0.52)", // Agencies
    "rgba(168,182,120,0.55)", // Ecommerce
    "rgba(160,144,196,0.55)", // SaaS
    "rgba(202,170,120,0.58)", // Coaches
  ];
