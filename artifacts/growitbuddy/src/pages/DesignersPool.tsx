...
const config: PoolConfig = {
  ...
  defaults: {
    ...
    resources: [
      { id: "1", title: "Design Brief",     desc: "Project context, audience, and creative direction.",          link: "https://drive.google.com/drive/folders/1A2B3C4D5E6F7G8H9I0J_DesignBrief",     btnLabel: "Open" },
      { id: "2", title: "Brand Kit",        desc: "Logos, typography, color palette, and usage guidelines.",     link: "https://drive.google.com/drive/folders/1BrandKit_XK9mN2pQ4rT6vW8xY0zA2bC4dE", btnLabel: "Download" },
      { id: "3", title: "Color Systems",    desc: "Primary, secondary, and accent color combinations.",          link: "https://drive.google.com/drive/folders/1ColorSys_F6hJ8kL0mN2pQ4rT6vW8xY0zA2", btnLabel: "Download" },
      { id: "4", title: "UI References",    desc: "Visual references and inspiration for the right aesthetic.",  link: "https://drive.google.com/drive/folders/1UIRef_B4dE6fG8hI0jK2lM4nO6pQ8rS0tU2",  btnLabel: "Open" },
    ],
