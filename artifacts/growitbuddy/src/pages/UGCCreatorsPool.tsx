...
const config: PoolConfig = {
  ...
  defaults: {
    ...
    resources: [
      { id: "1", title: "UGC References",     desc: "Examples of high-performing UGC across different niches.",     link: "https://drive.google.com/drive/folders/1UGCRef_R2sT4uV6wX8yZ0aB2cD4eF6gH8iJ0k",    btnLabel: "Open" },
      { id: "2", title: "Brand Guidelines",   desc: "What brands typically look for in UGC collaborations.",         link: "https://drive.google.com/drive/folders/1BrandGuide_L2mN4oP6qR8sT0uV2wX4yZ6aB8cD0", btnLabel: "Open" },
      { id: "3", title: "Shot Examples",      desc: "Visual references for framing, lighting, and delivery.",        link: "https://drive.google.com/drive/folders/1ShotEx_E2fG4hI6jK8lM0nO2pQ4rS6tU8vW0xY2",  btnLabel: "Download" },
      { id: "4", title: "Sample Scripts",     desc: "Hook structures and script frameworks for product videos.",     link: "https://drive.google.com/drive/folders/1SampleScr_Z4aB6cD8eF0gH2iJ4kL6mN8oP0qR2s", btnLabel: "Download" },
    ],
