...
var HOME_DEFAULTS = {
  ...
  proof: [
    { metric: "700M+", unit: "views generated", name: "Across content networks and brand campaigns", category: "Distribution \xB7 Multi-channel" },
    { metric: "200+", unit: "founders & brands served", name: "Across industries and content verticals", category: "Network \xB7 Global" },
    { metric: "90K+", unit: "content assets created", name: "Across high-volume pages and channels", category: "Content \xB7 High-Volume" }
  ],
  ...
  testimonials: [
    ...
    {
      quote: "I'm not a content person. I run a 14-person agency and I just needed someone to handle the LinkedIn stuff without making me cringe. They get the tone, they ship on time, and when something flopped they actually told me why instead of spinning it. That alone was worth it.",
      name: "Karan Sethi",
  ...
  ctaSubtext: "It's a distribution and authority problem. Book a free growth breakdown - we'll show you exactly what to fix and how.",
  ...
  values: [
    {
      ...
      description: "We build for impact, not visibility. Every piece of content is designed to build credibility and attract the right opportunities."
    },
    {
      title: "Systems, not one-offs",
      description: "We don't run campaigns. We build infrastructure - repeatable systems that compound and create leverage over time."
    },
    {
      title: "Radical clarity",
      description: "Our clients always know what's working, what isn't, and what's next. Honest, clear communication is the foundation of any great partnership."
    }
  ]
};

// src/lib/contactDefaults.ts
...
var WORK_DEFAULTS = {
  ...
  heroStats: [
    ...
    {
      eyebrow: "Services \xB7 Authority System",
      value: "200+",
    ...
    {
      eyebrow: "Content Engine \xB7 High Volume",
      value: "90K+",
  ...
  items: [
    { id: "1", title: "Built a SaaS founder into an industry voice", subtitle: "LinkedIn Authority Campaign", category: "B2B SaaS \xB7 LinkedIn", metric: "14M+", metricLabel: "impressions", description: "From zero presence to recognized authority in 6 months.", tags: [], stats: [], imageUrl: "" },
    { id: "2", title: "Agency owner authority engine", subtitle: "Multi-channel content strategy", category: "Services \xB7 Multi-channel", metric: "$2.4M", metricLabel: "inbound pipeline", description: "A systematic content strategy and distribution system drove inbound pipeline that exceeded prior annual revenue.", tags: [], stats: [], imageUrl: "" },
    { id: "3", title: "Creator monetization system", subtitle: "YouTube authority build", category: "Creator Economy \xB7 YouTube", metric: "250K", metricLabel: "subscribers", description: "A content strategy built around a proprietary framework compounded into 250K subscribers.", tags: [], stats: [], imageUrl: "" },
    { id: "4", title: "Executive personal brand", subtitle: "Podcast & PR strategy", category: "Leadership \xB7 Podcast & PR", metric: "15+", metricLabel: "speaking invites / qtr", description: "Personal branding strategy turned a quiet operator into a recognized industry thought leader with consistent media placement.", tags: [], stats: [], imageUrl: "" },
    { id: "5", title: "E-commerce founder growth", subtitle: "X / Twitter brand build", category: "E-commerce \xB7 X / Twitter", metric: "400%", metricLabel: "branded search growth", description: "A personal brand-first content marketing approach made this founder synonymous with their product category.", tags: [], stats: [], imageUrl: "" },
    { id: "6", title: "VC authority engine", subtitle: "LinkedIn positioning", category: "Finance \xB7 LinkedIn", metric: "3x", metricLabel: "deal flow growth", description: "Content strategy and personal branding positioned this venture firm as the category expert.", tags: [], stats: [], imageUrl: "" }
  ]
};

// src/lib/frameworkDefaults.ts
...
// src/lib/authorityAuditDefaults.ts
var AUTHORITY_AUDIT_DEFAULTS = {
...
// src/lib/influencerExploreDefaults.ts
var INFLUENCER_EXPLORE_DEFAULTS = {
...
// src/lib/distributionNetworkDefaults.ts
var DISTRIBUTION_NETWORK_DEFAULTS = {
...
// src/lib/fulltimeDefaults.ts
var FULLTIME_DEFAULTS = {
...
// src/lib/internshipDefaults.ts
var INTERNSHIP_DEFAULTS = {
...
// src/lib/freelancersDefaults.ts
var FREELANCERS_DEFAULTS = {
...
// src/lib/creatorSchoolDefaults.ts
var CREATOR_SCHOOL_DEFAULTS = {
...
// src/lib/privacyDefaults.ts
var PRIVACY_DEFAULTS = {
  badge: "Legal",
  title: "Privacy Policy",
  lastUpdated: "Last updated: 5 May 2026",
  intro: 'GrowitBuddy ("we", "our", or "us") respects your privacy and is committed to protecting your personal information. This Privacy Policy explains how we collect, use, and safeguard your data when you visit our website or submit information through our forms.',
  sections: [
    {
...
// src/lib/termsDefaults.ts
var TERMS_DEFAULTS = {
  badge: "Legal",
  title: "Terms & Conditions",
  lastUpdated: "Last updated: 5 May 2026",
  intro: "By accessing and using the GrowitBuddy website, you agree to the following terms.",
  sections: [
    {
...
// src/lib/joinNetworkDefaults.ts
var JOIN_NETWORK_DEFAULTS = {
...
// src/data/distributionPages.ts
var distributionPages = [
  {
    slug: "hustleempire",
    name: "Hustle Empire",
    handle: "@hustleempire",
...
// src/lib/networkFormDefaults.ts
var CREATORS_FORM_DEFAULTS = {
...
function isNoiseValue(s) {
  ...
  if (/^-?\d+(\.\d+)?(px|rem|em|vh|vw|%|s|ms)?$/i.test(t)) return true;
...
function renderContentBody(content, sections, h1) {
  ...
  for (const b2 of blocks) {
    const dedupe = b2.text.toLowerCase();
    if (seen.has(dedupe)) continue;
    seen.add(dedupe);
    parts.push(`<${b2.tag}>${escAttr(b2.text)}</${b2.tag}>`);
    if (parts.length >= 300) break;
  }
  if (parts.length <= 1) return "";
  return parts.join("");
}
function isEmptyContent(v2, depth = 0) {
  if (depth > 8) return false;
  if (v2 === null || v2 === void 0) return true;
  if (typeof v2 === "string") return v2.trim().length === 0;
  if (Array.isArray(v2)) return v2.every((x2) => isEmptyContent(x2, depth + 1));
  if (typeof v2 === "object") {
    const vals = Object.values(v2);
    return vals.length === 0 || vals.every((x2) => isEmptyContent(x2, depth + 1));
  }
  return false;
}
function mergeForBody(def, db) {
  if (isEmptyContent(db)) return def;
  if (def && db && typeof def === "object" && typeof db === "object" && !Array.isArray(def) && !Array.isArray(db)) {
    return { ...def, ...db };
  }
  return db;
}
