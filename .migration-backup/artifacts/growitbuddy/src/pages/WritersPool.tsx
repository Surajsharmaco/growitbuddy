...
const config: PoolConfig = {
  ...
  defaults: {
    ...
    resources: [
      { id: "1", title: "Script Frameworks",       desc: "Structures we use across short-form and long-form content.",  link: "https://drive.google.com/drive/folders/1ScriptFW_L2mN4oP6qR8sT0uV2wX4yZ6aB8", btnLabel: "Open" },
      { id: "2", title: "Writing Examples",         desc: "Real scripts and samples for reference and context.",          link: "https://drive.google.com/drive/folders/1WriteEx_C4dE6fG8hI0jK2lM4nO6pQ8rS0t",  btnLabel: "Open" },
      { id: "3", title: "Hook Systems",             desc: "Opening strategies that capture attention in the first line.", link: "https://drive.google.com/drive/folders/1HookSys_U2vW4xY6zA8bC0dE2fG4hI6jK8l", btnLabel: "Download" },
      { id: "4", title: "Storytelling Structures",  desc: "Narrative arcs and frameworks for building authority.",        link: "https://drive.google.com/drive/folders/1StoryStr_M0nO2pQ4rS6tU8vW0xY2zA4bC6d", btnLabel: "Download" },
    ],
